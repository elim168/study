...
import com.elim.learn.spring.bean.registry.Hello;
import com.elim.learn.spring.bean.registry.SpringConfiguration;
...
public class CustomBeanDefinitionRegistryTest {
	...
	public void assertBean() {
		Assert.assertTrue(applicationContext.getBeansOfType(Hello.class).size() == 2);
	}
